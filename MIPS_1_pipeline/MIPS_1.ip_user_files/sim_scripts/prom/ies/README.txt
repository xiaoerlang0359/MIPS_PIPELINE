...
#
# Generated by export_simulation on Mon Feb 24 11:08:38 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './prom.sh' script.
...
./prom.sh -noclean_files

For more information on the script, please type './prom.sh -help'.
