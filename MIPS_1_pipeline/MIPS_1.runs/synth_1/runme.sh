...
HD_PWD='E:/course/computer_architecture/MIPS1/MIPS_1/MIPS_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPS_1.tcl
