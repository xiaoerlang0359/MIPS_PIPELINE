...
HD_PWD='E:/course/computer_architecture/MIPS1/MIPS_1/MIPS_1.runs/prom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prom.tcl
